...
text = """Brazilië, officieel de Federale Republiek van Brazilië, is een land in Zuid-Amerika grenzend aan Frankrijk (Frans-Guyana), Suriname, Guyana, Venezuela, Colombia, Peru, Bolivia, Paraguay, Argentinië, Uruguay en de Atlantische Oceaan. Brasilia is de hoofdstad, São Paulo is de grootste stad in het land.
...
# text = "Afwisselende democratische en autocratische regeringen volgden elkaar op tot in de jaren 80 van de twintigste eeuw"
# text = "Brazilië is met zijn 8,5 miljoen vierkante kilometer, het grootste land van Zuid-Amerika"
# text = "Het is bovendien het vijfde grootste land ter wereld, de grootste van Zuid-Amerika, en de kleinste vandaag."
# text = "Peter en Hendrik vinden geel mooi, en blauw lelijk"
# text = "Peter vind geel het mooist en blauw het lelijksts"
# text = "Peter en Marco vind geel het mooist en blauw het lelijksts"
# text = "Brazilië is met zijn 8,5 miljoen vierkante kilometer het grootste land van Zuid-Amerika, het beslaat bijna de helft van dit continent."
# text = "De oorspronkelijke bevolking van Brazilië bestond uit indianen die de tropische kuststrook, het Paraná- en het Amazonebekken bewoonden."
# text = "Brasilia is de hoofdstad, São Paulo is de grootste stad in het land."
# Todo:
...
# text = "Op 16 juni 2015 stelde Trump zich officieel kandidaat voor de presidentsverkiezingen van 2016 als Republikein."
...
# text = "Werkte hij al voor het bedrijf van zijn vader en grootmoeder"
# text = "Vanaf eind juli 2015 stond hij bovenaan in de peilingen voor de Republikeinse nominatie, en sinds juli 2016 was hij de presidentskandidaat voor de Republikeinse Partij"
# text = "He was president-elect for the republican party sinds July 2016"
# text = "De oorspronkelijke bevolking van Brazilië bestond uit indianen die de tropische kuststrook, het Paraná- en het Amazonebekken bewoonden."
# text = "São Paulo is de grootste stad in het land"
# text = "Afwisselende democratische en autocratische regeringen volgden elkaar op tot in de jaren 80 van de twintigste eeuw."
# text = "De Braziliaanse grondwet omschrijft het land als een democratische federale republiek."
